...
public class DeleteBusinessSingleAccountCondition extends AttributeContainer implements KvmSerializable,java.io.Serializable
{

    
    public SingleAccountReference singleAccountReference;

    public DeleteBusinessSingleAccountCondition ()
    {
    }

    public DeleteBusinessSingleAccountCondition (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
