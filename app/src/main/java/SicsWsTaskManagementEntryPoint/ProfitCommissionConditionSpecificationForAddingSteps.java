...
public class ProfitCommissionConditionSpecificationForAddingSteps extends DomainObject implements KvmSerializable,java.io.Serializable
{
	...
	*/
	...
	/**
	* P.C. % for min Profit and below
	*/
    public BigDecimal lowestCommission=BigDecimal.ZERO;
    
	/**
	* P.C. % for max Profit and above
	*/
    public BigDecimal highestCommission=BigDecimal.ZERO;

    public ProfitCommissionConditionSpecificationForAddingSteps ()
    {
    }

    public ProfitCommissionConditionSpecificationForAddingSteps (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
