...
public class BrandedProductDetailKey extends DomainObject implements KvmSerializable,java.io.Serializable
{

    
    public SicsReferenceData brandedProduct;

    public BrandedProductDetailKey ()
    {
    }

    public BrandedProductDetailKey (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
