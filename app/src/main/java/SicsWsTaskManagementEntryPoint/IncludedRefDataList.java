...
public class IncludedRefDataList extends SelectedItemList implements KvmSerializable,java.io.Serializable
{
	...
	*/
    ...
    public IncludedRefDataList ()
    {
    }

    public IncludedRefDataList (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex>=count+0 && propertyIndex < count+0+this.includedRefData.size())
        {
            return this.includedRefData.get(propertyIndex-(count+0));
        }
    ...
    public int getPropertyCount() {
        return super.getPropertyCount()+0+includedRefData.size();
    }
