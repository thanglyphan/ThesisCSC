...
public class SicsPcClaimReference extends DomainObjectOrOperationReference implements KvmSerializable,java.io.Serializable
{

    
    public String claimIdentifier;

    public SicsPcClaimReference ()
    {
    }

    public SicsPcClaimReference (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
