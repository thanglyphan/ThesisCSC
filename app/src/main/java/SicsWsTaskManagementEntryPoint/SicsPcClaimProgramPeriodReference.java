...
public class SicsPcClaimProgramPeriodReference extends SicsPcClaimProgramReference implements KvmSerializable,java.io.Serializable
{

    
    public java.util.Date cpPeriodFrom;

    public SicsPcClaimProgramPeriodReference ()
    {
    }

    public SicsPcClaimProgramPeriodReference (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
