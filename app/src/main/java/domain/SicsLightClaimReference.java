...
public class SicsLightClaimReference extends DomainObjectOrOperationReference implements KvmSerializable,java.io.Serializable
{

    
    public String claimIdentifier;

    public SicsLightClaimReference ()
    {
    }

    public SicsLightClaimReference (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
