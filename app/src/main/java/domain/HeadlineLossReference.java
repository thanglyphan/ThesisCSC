...
public class HeadlineLossReference extends DomainObject implements KvmSerializable,java.io.Serializable
{

    
    public SicsHeadlineLossReference headlineLoss;

    public HeadlineLossReference ()
    {
    }

    public HeadlineLossReference (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
