...
public class ClaimToBusinessPartnerRelationship extends DomainObject implements KvmSerializable,java.io.Serializable
{
	...
	*/
	...
	/**
	* SubclassNumber: 530. Codes: ANY.
	*/
    public SicsReferenceDataReference claimBusinessPartnerTask;
    
    public Boolean isActive;

    public ClaimToBusinessPartnerRelationship ()
    {
    }

    public ClaimToBusinessPartnerRelationship (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("claimBusinessPartnerTask"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.claimBusinessPartnerTask = (SicsReferenceDataReference)__envelope.get(j,SicsReferenceDataReference.class,false);
                    }
                    continue;
                }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        {
            return this.claimBusinessPartnerTask!=null?this.claimBusinessPartnerTask:SoapPrimitive.NullSkip;
        }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        {
            info.type = SicsReferenceDataReference.class;
            info.name = "claimBusinessPartnerTask";
            info.namespace= "";
        }
        if(propertyIndex==count+4)
        {
