...
public class ClaimFromGroundUpElementKey extends ListUpdateElementKey implements KvmSerializable,java.io.Serializable
{

    
    public java.util.Date asOfDate;

    public ClaimFromGroundUpElementKey ()
    {
    }

    public ClaimFromGroundUpElementKey (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
