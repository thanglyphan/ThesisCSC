...
public class DeclarationForLightPolicyCreateUpdate extends AbstractScopeOfCoverForLightPolicyCreateUpdate implements KvmSerializable,java.io.Serializable
{

    
    public Boolean enlargeParentClassification;

    public DeclarationForLightPolicyCreateUpdate ()
    {
    }

    public DeclarationForLightPolicyCreateUpdate (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
