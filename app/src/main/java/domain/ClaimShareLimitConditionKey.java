...
public class ClaimShareLimitConditionKey extends ListUpdateElementKey implements KvmSerializable,java.io.Serializable
{

    
    public java.util.Date claimLimitShareAdviceDateAsDate;

    public ClaimShareLimitConditionKey ()
    {
    }

    public ClaimShareLimitConditionKey (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
