...
public class ResponsiblePersonKey extends ListUpdateElementKey implements KvmSerializable,java.io.Serializable
{

    
    public SicsReferenceDataReference responsibleUserRole;

    public ResponsiblePersonKey ()
    {
    }

    public ResponsiblePersonKey (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
