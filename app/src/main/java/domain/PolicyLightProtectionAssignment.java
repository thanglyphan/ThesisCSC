...
public class PolicyLightProtectionAssignment extends DomainObject implements KvmSerializable,java.io.Serializable
{
	...
	* Mandatory for scope of cover and  section related webserivces
	*/
    public LightBusinessRetrocessionList propProtectionAssignment;
    
	/**
	* Mandatory for scope of cover and  section related webserivces
	*/
    public LightBusinessRetrocessionList nonPropProtectionAssignment;

    public PolicyLightProtectionAssignment ()
    {
    }

    public PolicyLightProtectionAssignment (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("propProtectionAssignment"))
                {
                    if(obj!=null)
                    {
                        ...
                        this.propProtectionAssignment = new LightBusinessRetrocessionList(j,__envelope);
                    }
                    continue;
                }
                if (info.name.equals("nonPropProtectionAssignment"))
                {
                    ...
                    {
                        java.lang.Object j = obj;
                        this.nonPropProtectionAssignment = new LightBusinessRetrocessionList(j,__envelope);
                    }
                    continue;
                }
