...
public class LossEstimateKey extends ListUpdateElementKey implements KvmSerializable,java.io.Serializable
{

    
    public java.util.Date dateOfEstimate;

    public LossEstimateKey ()
    {
    }

    public LossEstimateKey (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
