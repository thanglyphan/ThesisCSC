...
public class CopyProtectionAssignmentInput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
    ...
    public SicsScopeOfCoverReference targetScopeOfCoverReference;

    public CopyProtectionAssignmentInput ()
    {
    }

    public CopyProtectionAssignmentInput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("targetScopeOfCoverReference"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.targetScopeOfCoverReference = (SicsScopeOfCoverReference)__envelope.get(j,SicsScopeOfCoverReference.class,false);
                    }
                    continue;
                }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==2)
        {
            return targetScopeOfCoverReference;
        }
        return null;
    }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        {
            info.type = SicsScopeOfCoverReference.class;
            info.name = "targetScopeOfCoverReference";
            info.namespace= "";
        }
    }
