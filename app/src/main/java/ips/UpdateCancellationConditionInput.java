...
public class UpdateCancellationConditionInput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
	...
	*/
    ...
    public CancellationConditionUpdate cancellationCondition;

    public UpdateCancellationConditionInput ()
    {
    }

    public UpdateCancellationConditionInput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("cancellationCondition"))
                {
                    ...
                    {
                        java.lang.Object j = obj;
                        this.cancellationCondition = (CancellationConditionUpdate)__envelope.get(j,CancellationConditionUpdate.class,false);
                    }
                    continue;
                }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==3)
        {
            info.type = CancellationConditionUpdate.class;
