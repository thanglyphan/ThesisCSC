...
public class DeleteBusinessConditionInput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{

    
    public Enums.BusinessConditionDeleteable businessCondition=Enums.BusinessConditionDeleteable.accountsCommonCondition;
	...
	*/
    ...
    public DeleteBusinessConditionInput ()
    {
    }

    public DeleteBusinessConditionInput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("businessCondition"))
                {
                    if(obj!=null)
                    {
                        ...
                        if (obj.getClass().equals(SoapPrimitive.class))
                        {
                            ...
                            if(j.toString()!=null)
                            {
                                this.businessCondition = Enums.BusinessConditionDeleteable.fromString(j.toString());
                            }
                        }
                        else if (obj instanceof Enums.BusinessConditionDeleteable){
                            this.businessCondition = (Enums.BusinessConditionDeleteable)obj;
                        }
                    }
                    continue;
                }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==0)
        {
            return this.businessCondition!=null?this.businessCondition.toString():SoapPrimitive.NullSkip;
        }
        if(propertyIndex==1)
        {
