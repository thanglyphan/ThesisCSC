...
public class BusinessPortfolioProgramSearchCriteria extends AbstractCriteria implements KvmSerializable,java.io.Serializable
{

    
    public SicsScopeOfCoverReference scopeOfCoverReference;

    public BusinessPortfolioProgramSearchCriteria ()
    {
    }

    public BusinessPortfolioProgramSearchCriteria (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
