...
public class BusinessPartnerGroupUpdate extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
	...
	*/
    ...
    public BusinessPartnerMembershipListUpdate businessPartnerMembershipListUpdate;

    public BusinessPartnerGroupUpdate ()
    {
    }

    public BusinessPartnerGroupUpdate (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("businessPartnerMembershipListUpdate"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.businessPartnerMembershipListUpdate = (BusinessPartnerMembershipListUpdate)__envelope.get(j,BusinessPartnerMembershipListUpdate.class,false);
                    }
                    continue;
                }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==7)
        {
            return this.businessPartnerMembershipListUpdate!=null?this.businessPartnerMembershipListUpdate:SoapPrimitive.NullSkip;
        }
        return null;
    }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==7)
        {
            info.type = BusinessPartnerMembershipListUpdate.class;
            info.name = "businessPartnerMembershipListUpdate";
            info.namespace= "";
        }
    }
