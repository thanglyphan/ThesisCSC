...
public class GenerateAccountingClassificationInput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{

    
    public SicsScopeOfCoverReference scopeOfCoverReference;

    public GenerateAccountingClassificationInput ()
    {
    }

    public GenerateAccountingClassificationInput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
