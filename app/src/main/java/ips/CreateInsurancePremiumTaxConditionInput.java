...
public class CreateInsurancePremiumTaxConditionInput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
	...
	* Details
	*/
    public InsurancePremiumTaxConditionList insurancePremiumTaxConditionList;
	...
	*/
    ...
    public CreateInsurancePremiumTaxConditionInput ()
    {
    }

    public CreateInsurancePremiumTaxConditionInput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("insurancePremiumTaxConditionList"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.insurancePremiumTaxConditionList = new InsurancePremiumTaxConditionList(j,__envelope);
                    }
                    continue;
                }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==2)
        {
            return this.insurancePremiumTaxConditionList!=null?this.insurancePremiumTaxConditionList:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==3)
        {
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==2)
        {
            ...
            info.name = "insurancePremiumTaxConditionList";
            info.namespace= "";
        }
        if(propertyIndex==3)
        {
