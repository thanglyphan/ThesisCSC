...
public class GenerateAutoProtectionCommitOutput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{

    
    public ProtectionAssignment protectionAssignment;

    public GenerateAutoProtectionCommitOutput ()
    {
    }

    public GenerateAutoProtectionCommitOutput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
