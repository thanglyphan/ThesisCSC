...
public class DeleteBusinessInput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{

    
    public SicsInsuredPeriodReference insuredPeriodReference;

    public DeleteBusinessInput ()
    {
    }

    public DeleteBusinessInput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
