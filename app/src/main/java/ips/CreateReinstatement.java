...
public class CreateReinstatement extends AttributeContainer implements KvmSerializable,java.io.Serializable
{

    
    public ReinstatementCondition reinstatement;

    public CreateReinstatement ()
    {
    }

    public CreateReinstatement (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
