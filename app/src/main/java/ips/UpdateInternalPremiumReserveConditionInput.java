...
public class UpdateInternalPremiumReserveConditionInput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
	...
	*/
    ...
    public InternalPremiumReserveConditionUpdate internalPremiumReserveCondition;

    public UpdateInternalPremiumReserveConditionInput ()
    {
    }

    public UpdateInternalPremiumReserveConditionInput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("internalPremiumReserveCondition"))
                {
                    ...
                    {
                        java.lang.Object j = obj;
                        this.internalPremiumReserveCondition = (InternalPremiumReserveConditionUpdate)__envelope.get(j,InternalPremiumReserveConditionUpdate.class,false);
                    }
                    continue;
                }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==3)
        {
            info.type = InternalPremiumReserveConditionUpdate.class;
