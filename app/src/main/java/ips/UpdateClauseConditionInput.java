...
public class UpdateClauseConditionInput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
    ...
    public ClauseConditionUpdate clauseCondition;

    public UpdateClauseConditionInput ()
    {
    }

    public UpdateClauseConditionInput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("clauseCondition"))
                {
                    ...
                    {
                        java.lang.Object j = obj;
                        this.clauseCondition = (ClauseConditionUpdate)__envelope.get(j,ClauseConditionUpdate.class,false);
                    }
                    continue;
                }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==2)
        {
            info.type = ClauseConditionUpdate.class;
