...
public class SicsLightInsuredPeriodReference extends SicsPolicyLightBusinessReference implements KvmSerializable,java.io.Serializable
{

    
    public java.util.Date beginDateTime;

    public SicsLightInsuredPeriodReference ()
    {
    }

    public SicsLightInsuredPeriodReference (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
