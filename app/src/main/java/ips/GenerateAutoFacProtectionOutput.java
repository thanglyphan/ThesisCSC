...
public class GenerateAutoFacProtectionOutput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{

    
    public ProtectionAssignment protectionAssignment;

    public GenerateAutoFacProtectionOutput ()
    {
    }

    public GenerateAutoFacProtectionOutput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
