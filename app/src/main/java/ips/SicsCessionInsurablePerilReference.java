...
public class SicsCessionInsurablePerilReference extends DomainObjectReference implements KvmSerializable,java.io.Serializable
{
    ...
    public SicsCessionInsurablePerilReference ()
    {
    }

    public SicsCessionInsurablePerilReference (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        {
            return this.insurablePerilReference!=null?this.insurablePerilReference:SoapPrimitive.NullSkip;
        }
