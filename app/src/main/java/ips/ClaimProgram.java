...
public class ClaimProgram extends DomainObject implements KvmSerializable,java.io.Serializable
{
	...
	*/
    ...
    public ClaimsClaimProgramCPPeriodsList cpPeriodList;
    
    public SicsBusinessPartnerReference broker;
    
    public SicsBusinessPartnerReference cedent;
    
    public SicsBusinessPartnerReference reinsurer;
    
	/**
	* SubclassNumber: 00066.
	*/
    public SicsReferenceDataReference cpCessionBasis;
    ...
    public ClaimProgram (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("cpPeriodList"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.cpPeriodList = new ClaimsClaimProgramCPPeriodsList(j,__envelope);
                    }
                    continue;
                }
                ...
                if (info.name.equals("cedent"))
                {
                    ...
                    {
                        java.lang.Object j = obj;
                        this.cedent = (SicsBusinessPartnerReference)__envelope.get(j,SicsBusinessPartnerReference.class,false);
                    }
                    continue;
                }
                if (info.name.equals("reinsurer"))
                {
                    ...
                    {
                        java.lang.Object j = obj;
                        this.reinsurer = (SicsBusinessPartnerReference)__envelope.get(j,SicsBusinessPartnerReference.class,false);
                    }
                    continue;
                }
                if (info.name.equals("cpCessionBasis"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.cpCessionBasis = (SicsReferenceDataReference)__envelope.get(j,SicsReferenceDataReference.class,false);
                    }
                    continue;
                }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        {
            return this.cpPeriodList!=null?this.cpPeriodList:SoapPrimitive.NullSkip;
        }
        ...
        {
            return this.cpCessionBasis!=null?this.cpCessionBasis:SoapPrimitive.NullSkip;
        }
