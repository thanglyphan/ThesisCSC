...
public class CreateAccountingClassificationInput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{

    
    public SicsScopeOfCoverReference scopeOfCoverReference;
    
    public AccountingClassificationSet accountingClassifications=new AccountingClassificationSet();

    public CreateAccountingClassificationInput ()
    {
    }

    public CreateAccountingClassificationInput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==1)
        {
            return accountingClassifications;
        }
        return null;
    }
