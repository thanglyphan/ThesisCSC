...
public class CreateBusinessPartnerGroupOutput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{

    
    public SicsBusinessPartnerGroupReference businessPartnerGroup;

    public CreateBusinessPartnerGroupOutput ()
    {
    }

    public CreateBusinessPartnerGroupOutput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
