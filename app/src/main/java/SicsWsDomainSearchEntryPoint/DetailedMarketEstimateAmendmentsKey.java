...
public class DetailedMarketEstimateAmendmentsKey extends ListUpdateElementKey implements KvmSerializable,java.io.Serializable
{

    
    public java.util.Date dateOfDetailedEstimate;

    public DetailedMarketEstimateAmendmentsKey ()
    {
    }

    public DetailedMarketEstimateAmendmentsKey (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
