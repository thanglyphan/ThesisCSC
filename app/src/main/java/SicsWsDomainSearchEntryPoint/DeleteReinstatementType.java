...
public class DeleteReinstatementType extends AttributeContainer implements KvmSerializable,java.io.Serializable
{

    
    public ReinstatementReference reinstatementReference;

    public DeleteReinstatementType ()
    {
    }

    public DeleteReinstatementType (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
