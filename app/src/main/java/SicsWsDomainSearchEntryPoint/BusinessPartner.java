...
public class BusinessPartner extends Party implements KvmSerializable,java.io.Serializable
{
	...
	*/
    ...
    public EMessaging eMessaging;

    public BusinessPartner ()
    {
    }

    public BusinessPartner (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("eMessaging"))
                {
                    ...
                    {
                        java.lang.Object j = obj;
                        this.eMessaging = (EMessaging)__envelope.get(j,EMessaging.class,false);
                    }
                    continue;
                }
    ...
    public int getPropertyCount() {
        return super.getPropertyCount()+20+businessPartnerCategory.size();
    }
