...
public class ClaimClaimGroupRelationshipUpdate extends AttributeContainer implements KvmSerializable,java.io.Serializable
{

    
    public BigDecimal allocationPercentage;

    public ClaimClaimGroupRelationshipUpdate ()
    {
    }

    public ClaimClaimGroupRelationshipUpdate (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
