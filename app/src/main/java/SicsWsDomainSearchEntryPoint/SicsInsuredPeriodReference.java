...
public class SicsInsuredPeriodReference extends SicsBusinessReference implements KvmSerializable,java.io.Serializable
{

    
	/**
	* If beginDateTime is not specified the reference will be resolved to the latest insured period.
	*/
    public java.util.Date beginDateTime;

    public SicsInsuredPeriodReference ()
    {
    }

    public SicsInsuredPeriodReference (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
