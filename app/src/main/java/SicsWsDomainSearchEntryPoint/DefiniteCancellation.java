...
public class DefiniteCancellation extends Cancellation implements KvmSerializable,java.io.Serializable
{

    
	/**
	* SubclassNumber: 55. SicsRefBusinessPartnerRelationshipType. CODE: CR | RR.
	*/
    public SicsReferenceDataReference businessPartnerRelationshipType;

    public DefiniteCancellation ()
    {
    }

    public DefiniteCancellation (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
