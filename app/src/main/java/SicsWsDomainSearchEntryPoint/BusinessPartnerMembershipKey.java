...
public class BusinessPartnerMembershipKey extends ListUpdateElementKey implements KvmSerializable,java.io.Serializable
{

    
    public SicsBusinessPartnerReference businessPartner;

    public BusinessPartnerMembershipKey ()
    {
    }

    public BusinessPartnerMembershipKey (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
