...
public class RevokeCancellationInput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{

    
    public SicsInsuredPeriodReference insuredPeriodReference;

    public RevokeCancellationInput ()
    {
    }

    public RevokeCancellationInput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
