...
public class AbstractPolicyLightRetrocessionToOutwardCedentsContract extends DomainObject implements KvmSerializable,java.io.Serializable
{

    
    public SicsScopeOfCoverReference scopeOfCoverReference;

    public AbstractPolicyLightRetrocessionToOutwardCedentsContract ()
    {
    }

    public AbstractPolicyLightRetrocessionToOutwardCedentsContract (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
