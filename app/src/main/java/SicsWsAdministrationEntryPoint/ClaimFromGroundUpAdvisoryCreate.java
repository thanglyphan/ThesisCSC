...
public class ClaimFromGroundUpAdvisoryCreate extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
	...
	/**
	* Record Current / Record Adjustment
	*                   This represents boolean choices for the radio buttons.
	*/
    public Boolean recordCurrent;
    
    public ClaimFromGroundUpAdvisoryDetailList fguAdvisoryDetailList;
    ...
    public ClaimFromGroundUpAdvisoryCreate ()
    {
    }

    public ClaimFromGroundUpAdvisoryCreate (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("recordCurrent"))
                {
                    if(obj!=null)
                    {
                        ...
                        if (obj.getClass().equals(SoapPrimitive.class))
                        {
                            ...
                            if(j.toString()!=null)
                            {
                                this.recordCurrent = new Boolean(j.toString());
                            }
                        }
                        else if (obj instanceof Boolean){
                            this.recordCurrent = (Boolean)obj;
                        }
                    }
                    continue;
                }
                if (info.name.equals("fguAdvisoryDetailList"))
                {
                    if(obj!=null)
                    {
                        ...
                        this.fguAdvisoryDetailList = new ClaimFromGroundUpAdvisoryDetailList(j,__envelope);
                    }
                    continue;
                }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==1)
        {
            return this.recordCurrent!=null?this.recordCurrent:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==2)
        {
