...
public class UpdateAccountsCommonConditionInput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
	...
	*/
    ...
    public PcAccountsCommonCondition accountsCommonCondition;
    
    public java.util.Date selectedAccountStartDate;

    public UpdateAccountsCommonConditionInput ()
    {
    }

    public UpdateAccountsCommonConditionInput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("accountsCommonCondition"))
                {
                    ...
                    {
                        java.lang.Object j = obj;
                        this.accountsCommonCondition = (PcAccountsCommonCondition)__envelope.get(j,PcAccountsCommonCondition.class,false);
                    }
                    continue;
                }
                if (info.name.equals("selectedAccountStartDate"))
                {
                    if(obj!=null)
                    {
                        ...
                        if (obj.getClass().equals(SoapPrimitive.class))
                        {
                            ...
                            if(j.toString()!=null)
                            {
                                this.selectedAccountStartDate = Helper.ConvertFromWebService(j.toString());
                            }
                        }
                        else if (obj instanceof java.util.Date){
                            this.selectedAccountStartDate = (java.util.Date)obj;
                        }
                    }
                    continue;
                }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==4)
        {
            return this.selectedAccountStartDate!=null?Helper.getDateFormat().format(this.selectedAccountStartDate):SoapPrimitive.NullSkip;
        }
        return null;
    }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==3)
        {
            info.type = PcAccountsCommonCondition.class;
        ...
        {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "selectedAccountStartDate";
            info.namespace= "";
        }
    }
