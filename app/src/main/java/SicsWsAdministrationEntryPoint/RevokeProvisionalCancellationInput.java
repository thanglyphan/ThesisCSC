...
public class RevokeProvisionalCancellationInput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{

    
    public SicsInsuredPeriodReference insuredPeriodReference;

    public RevokeProvisionalCancellationInput ()
    {
    }

    public RevokeProvisionalCancellationInput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
