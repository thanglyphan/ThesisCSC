...
public class TaskStatusList extends Vector< SicsReferenceDataReference> implements KvmSerializable,java.io.Serializable
{
    
    public TaskStatusList(){}
    
    public TaskStatusList(java.lang.Object inObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        if (inObj == null)
            return;
