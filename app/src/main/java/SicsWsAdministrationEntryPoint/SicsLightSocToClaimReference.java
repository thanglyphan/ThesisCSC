...
public class SicsLightSocToClaimReference extends SicsLightClaimReference implements KvmSerializable,java.io.Serializable
{

    
    public SicsLightScopeOfCoverReference lightScopeOfCoverReference;

    public SicsLightSocToClaimReference ()
    {
    }

    public SicsLightSocToClaimReference (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
