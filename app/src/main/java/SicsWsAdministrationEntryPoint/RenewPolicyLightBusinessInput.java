...
public class RenewPolicyLightBusinessInput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
    ...
    public InsuredPeriodOfPolicyLightCreate insuredPeriodOfPolicyLight;

    public RenewPolicyLightBusinessInput ()
    {
    }

    public RenewPolicyLightBusinessInput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("insuredPeriodOfPolicyLight"))
                {
                    ...
                    {
                        java.lang.Object j = obj;
                        this.insuredPeriodOfPolicyLight = (InsuredPeriodOfPolicyLightCreate)__envelope.get(j,InsuredPeriodOfPolicyLightCreate.class,false);
                    }
                    continue;
                }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==2)
        {
            info.type = InsuredPeriodOfPolicyLightCreate.class;
