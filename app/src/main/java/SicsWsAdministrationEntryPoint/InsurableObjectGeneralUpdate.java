...
public class InsurableObjectGeneralUpdate extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
	...
	*/
    ...
    public InsurableObjectAliasListUpdate insurableObjectAliasListUpdate;
    
    public InsurableObjectOwnerListUpdate insurableObjectOwnerListUpdate;
    
    public InsurableObjectIdentifierListUpdate insurableObjectIdentifierListUpdate;

    public InsurableObjectGeneralUpdate ()
    {
    }

    public InsurableObjectGeneralUpdate (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("insurableObjectAliasListUpdate"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.insurableObjectAliasListUpdate = (InsurableObjectAliasListUpdate)__envelope.get(j,InsurableObjectAliasListUpdate.class,false);
                    }
                    continue;
                }
                if (info.name.equals("insurableObjectOwnerListUpdate"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.insurableObjectOwnerListUpdate = (InsurableObjectOwnerListUpdate)__envelope.get(j,InsurableObjectOwnerListUpdate.class,false);
                    }
                    continue;
                }
                if (info.name.equals("insurableObjectIdentifierListUpdate"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.insurableObjectIdentifierListUpdate = (InsurableObjectIdentifierListUpdate)__envelope.get(j,InsurableObjectIdentifierListUpdate.class,false);
                    }
                    continue;
                }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==10)
        {
            return this.insurableObjectAliasListUpdate!=null?this.insurableObjectAliasListUpdate:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==11)
        {
            return this.insurableObjectOwnerListUpdate!=null?this.insurableObjectOwnerListUpdate:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==12)
        {
            return this.insurableObjectIdentifierListUpdate!=null?this.insurableObjectIdentifierListUpdate:SoapPrimitive.NullSkip;
        }
        return null;
    }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==10)
        {
            info.type = InsurableObjectAliasListUpdate.class;
            info.name = "insurableObjectAliasListUpdate";
            info.namespace= "";
        }
        if(propertyIndex==11)
        {
            info.type = InsurableObjectOwnerListUpdate.class;
            info.name = "insurableObjectOwnerListUpdate";
            info.namespace= "";
        }
        if(propertyIndex==12)
        {
            info.type = InsurableObjectIdentifierListUpdate.class;
            info.name = "insurableObjectIdentifierListUpdate";
            info.namespace= "";
        }
    }
