...
public class RetrieveRecordedProtectionAssignmentOutput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{

    
    public ProtectionAssignment protectionAssignment;

    public RetrieveRecordedProtectionAssignmentOutput ()
    {
    }

    public RetrieveRecordedProtectionAssignmentOutput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
