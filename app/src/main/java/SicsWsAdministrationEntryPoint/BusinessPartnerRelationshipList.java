...
public class BusinessPartnerRelationshipList extends ReplaceAllList implements KvmSerializable,java.io.Serializable
{
    ...
    public BusinessPartnerRelationshipList ()
    {
    }

    public BusinessPartnerRelationshipList (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex>=count+0 && propertyIndex < count+0+this.businessPartnerRelationship.size())
        {
            return this.businessPartnerRelationship.get(propertyIndex-(count+0));
        }
    ...
    public int getPropertyCount() {
        return super.getPropertyCount()+0+businessPartnerRelationship.size();
    }
