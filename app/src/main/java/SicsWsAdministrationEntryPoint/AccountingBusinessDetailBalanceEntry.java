...
/**
* AccountingBusinessDetailBalanceEntry represents one line in the detail container (actual account or estimate) on technical worksheet GUI.
*/
public class AccountingBusinessDetailBalanceEntry extends AccountingDetailBalanceEntry implements KvmSerializable,java.io.Serializable
{
	...
	* To be Split column
	*/
    public Boolean isCandidateForBeingSplit;
	...
	*/
	...
	/**
	* If this element is present and is true then booking will be split per Accounting Classification Percent.
	*/
    public Boolean bookingToBeSplitPerAccountingClassificationPercent;
	...
	*/
    ...
    public AccountingBusinessDetailBalanceEntry ()
    {
    }

    public AccountingBusinessDetailBalanceEntry (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("isCandidateForBeingSplit"))
                {
                    if(obj!=null)
                    {
                        ...
                        if (obj.getClass().equals(SoapPrimitive.class))
                        {
                            ...
                            if(j.toString()!=null)
                            {
                                this.isCandidateForBeingSplit = new Boolean(j.toString());
                            }
                        }
                        else if (obj instanceof Boolean){
                            this.isCandidateForBeingSplit = (Boolean)obj;
                        }
                    }
                    continue;
                }
                ...
                if (info.name.equals("bookingToBeSplitPerAccountingClassificationPercent"))
                {
                    if(obj!=null)
                    {
                        ...
                        if (obj.getClass().equals(SoapPrimitive.class))
                        {
                            ...
                            if(j.toString()!=null)
                            {
                                this.bookingToBeSplitPerAccountingClassificationPercent = new Boolean(j.toString());
                            }
                        }
                        else if (obj instanceof Boolean){
                            this.bookingToBeSplitPerAccountingClassificationPercent = (Boolean)obj;
                        }
                    }
                    continue;
                }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        {
            return this.isCandidateForBeingSplit!=null?this.isCandidateForBeingSplit:SoapPrimitive.NullSkip;
        }
        ...
        {
            return this.bookingToBeSplitPerAccountingClassificationPercent!=null?this.bookingToBeSplitPerAccountingClassificationPercent:SoapPrimitive.NullSkip;
        }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        {
            info.type = PropertyInfo.BOOLEAN_CLASS;
            info.name = "isCandidateForBeingSplit";
            info.namespace= "";
        }
        if(propertyIndex==count+5)
        {
        ...
        {
            info.type = PropertyInfo.BOOLEAN_CLASS;
            info.name = "bookingToBeSplitPerAccountingClassificationPercent";
            info.namespace= "";
        }
        if(propertyIndex==count+10)
        {
