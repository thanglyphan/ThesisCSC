...
public class EditClassificationInput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
    ...
    public EditClassificationInput ()
    {
    }

    public EditClassificationInput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("classification"))
                {
                    ...
                    {
                        java.lang.Object j = obj;
                        this.classification = (Classification)__envelope.get(j,Classification.class,false);
                    }
                    continue;
                }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==1)
        {
            info.type = Classification.class;
