...
public class ClaimUpdate extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
	...
	*/
	...
	/**
	* Edit Claim Commutation window
	*/
    public ClaimCommutationList claimCommutationList;
    
    public LossEstimateList lossEstimateList;
    
    public LossEstimateListUpdate lossEstimateListUpdate;
    
	/**
	* EDI FGU Figures
	*/
    public EdiFguInfoAsOfDateList ediFguAsOfDateList;
    
    public EdiFguInfoAsOfDateListUpdate ediFguAsOfDateListUpdate;
	...
	/**
	* Assign To Next Period
	*                   This is available only for Interlocking Claims.
	*/
    public ClaimScopeOfCoverToClaimRelationshipCreateForInterlocking assignToNextPeriodSOC;
    
	/**
	* Assign To Previous Period
	*                   This is available only for Interlocking Claims.
	*/
    public ClaimScopeOfCoverToClaimRelationshipCreateForInterlocking assignToPreviousPeriodSOC;
    
    public ClaimSubstituteScopeOfCoverToClaimRelationship assignToNextPeriodSubstituteSOC;
    
    public ClaimSubstituteScopeOfCoverToClaimRelationship assignToPreviousPeriodSubstituteSOC;
    
    public ClaimScopeOfCoverToClaimRelationshipUpdate scopeOfCoverRelation;

    public ClaimUpdate ()
    {
    }

    public ClaimUpdate (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("claimCommutationList"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.claimCommutationList = (ClaimCommutationList)__envelope.get(j,ClaimCommutationList.class,false);
                    }
                    continue;
                }
                if (info.name.equals("lossEstimateList"))
                {
                    ...
                    {
                        java.lang.Object j = obj;
                        this.lossEstimateList = new LossEstimateList(j,__envelope);
                    }
                    continue;
                }
                if (info.name.equals("lossEstimateListUpdate"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.lossEstimateListUpdate = (LossEstimateListUpdate)__envelope.get(j,LossEstimateListUpdate.class,false);
                    }
                    continue;
                }
                if (info.name.equals("ediFguAsOfDateList"))
                {
                    ...
                    {
                        java.lang.Object j = obj;
                        this.ediFguAsOfDateList = new EdiFguInfoAsOfDateList(j,__envelope);
                    }
                    continue;
                }
                if (info.name.equals("ediFguAsOfDateListUpdate"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.ediFguAsOfDateListUpdate = (EdiFguInfoAsOfDateListUpdate)__envelope.get(j,EdiFguInfoAsOfDateListUpdate.class,false);
                    }
                    continue;
                }
                ...
                if (info.name.equals("assignToNextPeriodSOC"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.assignToNextPeriodSOC = (ClaimScopeOfCoverToClaimRelationshipCreateForInterlocking)__envelope.get(j,ClaimScopeOfCoverToClaimRelationshipCreateForInterlocking.class,false);
                    }
                    continue;
                }
                if (info.name.equals("assignToPreviousPeriodSOC"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.assignToPreviousPeriodSOC = (ClaimScopeOfCoverToClaimRelationshipCreateForInterlocking)__envelope.get(j,ClaimScopeOfCoverToClaimRelationshipCreateForInterlocking.class,false);
                    }
                    continue;
                }
                if (info.name.equals("assignToNextPeriodSubstituteSOC"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.assignToNextPeriodSubstituteSOC = (ClaimSubstituteScopeOfCoverToClaimRelationship)__envelope.get(j,ClaimSubstituteScopeOfCoverToClaimRelationship.class,false);
                    }
                    continue;
                }
                if (info.name.equals("assignToPreviousPeriodSubstituteSOC"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.assignToPreviousPeriodSubstituteSOC = (ClaimSubstituteScopeOfCoverToClaimRelationship)__envelope.get(j,ClaimSubstituteScopeOfCoverToClaimRelationship.class,false);
                    }
                    continue;
                }
                if (info.name.equals("scopeOfCoverRelation"))
                {
                    ...
                    {
                        java.lang.Object j = obj;
                        this.scopeOfCoverRelation = (ClaimScopeOfCoverToClaimRelationshipUpdate)__envelope.get(j,ClaimScopeOfCoverToClaimRelationshipUpdate.class,false);
                    }
                    continue;
                }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==47)
        {
            return this.claimCommutationList!=null?this.claimCommutationList:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==48)
        {
        ...
        if(propertyIndex==49)
        {
            return this.lossEstimateListUpdate!=null?this.lossEstimateListUpdate:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==50)
        {
        ...
        if(propertyIndex==51)
        {
            return this.ediFguAsOfDateListUpdate!=null?this.ediFguAsOfDateListUpdate:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==52)
        {
        ...
        if(propertyIndex==54)
        {
            return this.assignToNextPeriodSOC!=null?this.assignToNextPeriodSOC:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==55)
        {
            return this.assignToPreviousPeriodSOC!=null?this.assignToPreviousPeriodSOC:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==56)
        {
            return this.assignToNextPeriodSubstituteSOC!=null?this.assignToNextPeriodSubstituteSOC:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==57)
        {
            return this.assignToPreviousPeriodSubstituteSOC!=null?this.assignToPreviousPeriodSubstituteSOC:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==58)
        {
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==47)
        {
            info.type = ClaimCommutationList.class;
            info.name = "claimCommutationList";
            info.namespace= "";
        }
        if(propertyIndex==48)
        {
        ...
        if(propertyIndex==49)
        {
            info.type = LossEstimateListUpdate.class;
            info.name = "lossEstimateListUpdate";
            info.namespace= "";
        }
        if(propertyIndex==50)
        {
        ...
        if(propertyIndex==51)
        {
            info.type = EdiFguInfoAsOfDateListUpdate.class;
            info.name = "ediFguAsOfDateListUpdate";
            info.namespace= "";
        }
        if(propertyIndex==52)
        {
        ...
        if(propertyIndex==54)
        {
            info.type = ClaimScopeOfCoverToClaimRelationshipCreateForInterlocking.class;
            info.name = "assignToNextPeriodSOC";
            info.namespace= "";
        }
        if(propertyIndex==55)
        {
            info.type = ClaimScopeOfCoverToClaimRelationshipCreateForInterlocking.class;
            info.name = "assignToPreviousPeriodSOC";
            info.namespace= "";
        }
        if(propertyIndex==56)
        {
            info.type = ClaimSubstituteScopeOfCoverToClaimRelationship.class;
            info.name = "assignToNextPeriodSubstituteSOC";
            info.namespace= "";
        }
        if(propertyIndex==57)
        {
            info.type = ClaimSubstituteScopeOfCoverToClaimRelationship.class;
            info.name = "assignToPreviousPeriodSubstituteSOC";
            info.namespace= "";
        }
        if(propertyIndex==58)
        {
            info.type = ClaimScopeOfCoverToClaimRelationshipUpdate.class;
