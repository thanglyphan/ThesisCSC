...
public class BookingControlOnScopeOfCover extends DomainObject implements KvmSerializable,java.io.Serializable
{
	...
	/**
	* transferToLedger is mandatory field for Creating a Claim Program but not for Update.
	*/
    public Boolean transferToLedger;

    public BookingControlOnScopeOfCover ()
    {
    }

    public BookingControlOnScopeOfCover (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
