...
public class ClaimAccountingStatisticEntryCodeItem extends ClaimAccountingStatisticItem implements KvmSerializable,java.io.Serializable
{

    
    public SicsAccountingEntryCodeReference entryCode;

    public ClaimAccountingStatisticEntryCodeItem ()
    {
    }

    public ClaimAccountingStatisticEntryCodeItem (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
