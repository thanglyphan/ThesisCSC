...
public class CreateBusinessUnderlyingBusinessInput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{

    
	/**
	* Business should be Prop-Treaty .
	*/
	...
	*/
    ...
    public BusinessUnderlyingBusiness businessUnderlyingBusiness;

    public CreateBusinessUnderlyingBusinessInput ()
    {
    }

    public CreateBusinessUnderlyingBusinessInput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("businessUnderlyingBusiness"))
                {
                    ...
                    {
                        java.lang.Object j = obj;
                        this.businessUnderlyingBusiness = (BusinessUnderlyingBusiness)__envelope.get(j,BusinessUnderlyingBusiness.class,false);
                    }
                    continue;
                }
