...
public class CreateHeadlineLossOutput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{

    
    public SicsHeadlineLossReference headlineLoss;

    public CreateHeadlineLossOutput ()
    {
    }

    public CreateHeadlineLossOutput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
