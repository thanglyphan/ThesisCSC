...
public class CountryGroupList extends Vector< SicsAreaGroupCountryReference> implements KvmSerializable,java.io.Serializable
{
    
    public CountryGroupList(){}
    
    public CountryGroupList(java.lang.Object inObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        if (inObj == null)
            return;
