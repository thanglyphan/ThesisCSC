...
public class CobsList extends Vector< SicsReferenceDataReference> implements KvmSerializable,java.io.Serializable
{
    
    public CobsList(){}
    
    public CobsList(java.lang.Object inObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        if (inObj == null)
            return;
