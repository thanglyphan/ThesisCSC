...
public class ClaimsClaimProgramCPPeriodUpdate extends DomainObject implements KvmSerializable,java.io.Serializable
{
	...
	*/
    ...
    public BookingControlOnScopeOfCoverListUpdate bookingControlOnScopeOfCoverListUpdate;
    
    public SicsUserReference responsibleUser;

    public ClaimsClaimProgramCPPeriodUpdate ()
    {
    }

    public ClaimsClaimProgramCPPeriodUpdate (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("bookingControlOnScopeOfCoverListUpdate"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.bookingControlOnScopeOfCoverListUpdate = (BookingControlOnScopeOfCoverListUpdate)__envelope.get(j,BookingControlOnScopeOfCoverListUpdate.class,false);
                    }
                    continue;
                }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        {
            return this.bookingControlOnScopeOfCoverListUpdate!=null?this.bookingControlOnScopeOfCoverListUpdate:SoapPrimitive.NullSkip;
        }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==count+14)
        {
            info.type = BookingControlOnScopeOfCoverListUpdate.class;
            info.name = "bookingControlOnScopeOfCoverListUpdate";
            info.namespace= "";
        }
        if(propertyIndex==count+15)
        {
