...
public class PlacementList extends Vector< SicsBusinessReference> implements KvmSerializable,java.io.Serializable
{
    
    public PlacementList(){}
    
    public PlacementList(java.lang.Object inObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        if (inObj == null)
            return;
