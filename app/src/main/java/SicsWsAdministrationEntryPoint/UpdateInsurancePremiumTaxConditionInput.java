...
public class UpdateInsurancePremiumTaxConditionInput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{
	...
	* Details
	*/
    public InsurancePremiumTaxConditionListUpdate insurancePremiumTaxConditionListUpdate;
	...
	*/
    ...
    public UpdateInsurancePremiumTaxConditionInput ()
    {
    }

    public UpdateInsurancePremiumTaxConditionInput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if(inObj instanceof SoapObject)
        {
            ...
            for (int i0=0;i0< size;i0++)
            {
                ...
                if (info.name.equals("insurancePremiumTaxConditionListUpdate"))
                {
                    if(obj!=null)
                    {
                        java.lang.Object j = obj;
                        this.insurancePremiumTaxConditionListUpdate = (InsurancePremiumTaxConditionListUpdate)__envelope.get(j,InsurancePremiumTaxConditionListUpdate.class,false);
                    }
                    continue;
                }
    ...
    public java.lang.Object getProperty(int propertyIndex) {
        ...
        if(propertyIndex==2)
        {
            return this.insurancePremiumTaxConditionListUpdate!=null?this.insurancePremiumTaxConditionListUpdate:SoapPrimitive.NullSkip;
        }
        if(propertyIndex==3)
        {
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        ...
        if(propertyIndex==2)
        {
            info.type = InsurancePremiumTaxConditionListUpdate.class;
            info.name = "insurancePremiumTaxConditionListUpdate";
            info.namespace= "";
        }
        if(propertyIndex==3)
        {
