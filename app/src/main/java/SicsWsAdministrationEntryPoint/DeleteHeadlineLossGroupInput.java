...
public class DeleteHeadlineLossGroupInput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{

    
    public SicsPcHeadlineLossGroupReference headlineLossGroupReference;

    public DeleteHeadlineLossGroupInput ()
    {
    }

    public DeleteHeadlineLossGroupInput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
