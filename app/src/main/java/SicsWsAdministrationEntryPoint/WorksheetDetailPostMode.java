...
public class WorksheetDetailPostMode extends AttributeContainer implements KvmSerializable,java.io.Serializable
{

    
    public WorksheetLedgerEntryList worksheetLedgerEntryList;

    public WorksheetDetailPostMode ()
    {
    }

    public WorksheetDetailPostMode (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
