...
public class SicsTaskManagementProcessTemplateReference extends DomainObjectOrOperationReference implements KvmSerializable,java.io.Serializable
{

    
    public String processTemplateIdentifier;

    public SicsTaskManagementProcessTemplateReference ()
    {
    }

    public SicsTaskManagementProcessTemplateReference (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
