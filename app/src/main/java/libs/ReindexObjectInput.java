...
public class ReindexObjectInput extends AttributeContainer implements KvmSerializable,java.io.Serializable
{

    
    public DomainObjectReference referenceObject;

    public ReindexObjectInput ()
    {
    }

    public ReindexObjectInput (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
