...
public class SicsWsSicsSearchEntryPointBinding
{
    ...
    public SicsWsSicsSearchEntryPointBinding(){}

    public SicsWsSicsSearchEntryPointBinding (IServiceEvents callback)
    {
        this.callback = callback;
    }
    public SicsWsSicsSearchEntryPointBinding(IServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public SicsWsSicsSearchEntryPointBinding(IServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    public Boolean reindexObject(final SicsGenericInput genericInput,final ReindexObjectInput reindexObjectIn ) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new IWcfMethod()
        {
            ...
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
              ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
                ...
                __envelope.addMapping("","reindexObjectIn",new ReindexObjectInput().getClass());
                SoapObject __soapReq = new SoapObject("urn:SicsWsSicsSearchEntryPoint", "reindexObject");
                ...
                __info = new PropertyInfo();
                __info.namespace="";
                __info.name="reindexObjectIn";
                __info.type=ReindexObjectInput.class;
                __info.setValue(reindexObjectIn!=null?reindexObjectIn:SoapPrimitive.NullNilElement);
                __soapReq.addProperty(__info);
                return __envelope;
            }
            ...
            public java.lang.Object ProcessResult(ExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
                ...
                java.lang.Object obj = __soap.getProperty("reindexObjectOut");
        ...
        },"http://www.SicsWsSicsSearchEntryPoint.com/SicsWsSicsSearchEntryPoint-interface/reindexObject",__profile);
    }
    
    public android.os.AsyncTask< Void, Void, OperationResult< Boolean>> reindexObjectAsync(final SicsGenericInput genericInput,final ReindexObjectInput reindexObjectIn)
    {
        return executeAsync(new Functions.IFunc< Boolean>() {
            public Boolean Func() throws java.lang.Exception {
                return reindexObject( genericInput,reindexObjectIn);
            }
        });
    }
