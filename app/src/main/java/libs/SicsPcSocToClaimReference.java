...
public class SicsPcSocToClaimReference extends SicsAbstractPcSocToClaimReference implements KvmSerializable,java.io.Serializable
{

    
    public SicsScopeOfCoverReference scopeOfCoverReference;

    public SicsPcSocToClaimReference ()
    {
    }

    public SicsPcSocToClaimReference (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
