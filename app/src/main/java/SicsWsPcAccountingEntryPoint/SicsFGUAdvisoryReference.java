...
public class SicsFGUAdvisoryReference extends SicsPcClaimReference implements KvmSerializable,java.io.Serializable
{
	...
	/**
	* This field must be defaulted to zero.
	*/
    public Integer sequence=0;

    public SicsFGUAdvisoryReference ()
    {
    }

    public SicsFGUAdvisoryReference (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
