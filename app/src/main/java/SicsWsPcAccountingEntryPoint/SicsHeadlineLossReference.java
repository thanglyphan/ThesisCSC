...
public class SicsHeadlineLossReference extends DomainObjectOrOperationReference implements KvmSerializable,java.io.Serializable
{

    
    public String claimIdentifier;

    public SicsHeadlineLossReference ()
    {
    }

    public SicsHeadlineLossReference (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
