...
public class ClaimDispositionKey extends ListUpdateElementKey implements KvmSerializable,java.io.Serializable
{

    
    public java.util.Date dateOfChange;

    public ClaimDispositionKey ()
    {
    }

    public ClaimDispositionKey (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
