...
public class ReportingUnitRelationKey extends ListUpdateElementKey implements KvmSerializable,java.io.Serializable
{

    
    public SicsReportingUnitReference reportingUnit;

    public ReportingUnitRelationKey ()
    {
    }

    public ReportingUnitRelationKey (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
